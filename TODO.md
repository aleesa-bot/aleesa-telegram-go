...
-1. [V] Переделать layout на "стандартный" гошный.
...
3. Обработчик группы команд admin, сохранение настроек в pebbledb.
   ...
   2 [V] [V] фортунка каждое утро. См. п.13.
